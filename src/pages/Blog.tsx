...
function Blog() {
  const featuredPost = {
    ...
    excerpt: "Discover how listening to your body's natural hunger and fullness cues can lead to better health outcomes and a more balanced relationship with food.",
  ...
  const posts = [
    {
      ...
      excerpt: "Learn about proteins, carbohydrates, and fats, and how they contribute to your overall health and fitness goals.",
    ...
    },
    {
      ...
      excerpt: "Effective meal planning and preparation techniques to maintain a healthy diet despite a hectic schedule.",
    ...
    },
    {
      ...
      excerpt: "Exploring the connection between digestive health and various aspects of physical and mental well-being.",
    ...
    },
    {
      ...
      excerpt: "How to make environmentally conscious food choices while maintaining optimal nutrition.",
    ...
    },
    {
      ...
      excerpt: "Essential nutrition strategies for athletes and active individuals to enhance performance and recovery.",
    ...
    },
    {
      ...
      excerpt: "Practicing mindful eating habits in a world full of distractions and quick-fix solutions.",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white/70 backdrop-blur-sm rounded-3xl overflow-hidden shadow-xl mb-20">
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="p-8 md:p-12 flex flex-col justify-center">
                ...
                <Link to="/blog/featured" className="flex items-center text-Lg font-semibold hover:text-Mg transition-colors">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {posts.map((post, index) => (
              <Link to={`/blog/${index}`} key={index} className="block">
